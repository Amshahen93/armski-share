...
@Component({
  selector: 'app-mount-kazbegi',
  templateUrl: './mount-kazbegi.component.html',
  styleUrls: ['./mount-kazbegi.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MountKazbegiComponent implements OnInit {
  tourImage!: string;
  count = 0;
  firstRout = 'ski-mountaineering';
  tourName!: string;
  tourData: Tour = skiMountaineeringTours[0];
  images: string [] = [];
  pages = [{
    name: 'DESCRIPTION'
  }, {
